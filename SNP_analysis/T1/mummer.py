...
delta_file = "/scratch/jkbrook/BIOE_4510/SNP_analysis/T1/nucmer.delta"
ref_file = "/scratch/jkbrook/BIOE_4510/SNP_analysis/T1/NC_045512.fa"
query_file = "/scratch/jkbrook/BIOE_4510/SNP_analysis/T1/117M18E37DBC9AD1KM.consensus.fa"
...
for line in delta_lines:
    if line.startswith("NUCMER"):
        ...
        _, ref, query = line.strip().split()
    else:
        ref_pos, ref_len, query_pos, query_len, _, _ = map(int, line.strip().split())
